...
# OPAM configuration
#. /home/markus/.opam/opam-init/init.zsh > /dev/null 2> /dev/null || true

PATH="/home/markus/perl5/bin${PATH+:}${PATH}"; export PATH;
PERL5LIB="/home/markus/perl5/lib/perl5${PERL5LIB+:}${PERL5LIB}"; export PERL5LIB;
PERL_LOCAL_LIB_ROOT="/home/markus/perl5${PERL_LOCAL_LIB_ROOT+:}${PERL_LOCAL_LIB_ROOT}"; export PERL_LOCAL_LIB_ROOT;
PERL_MB_OPT="--install_base \"/home/markus/perl5\""; export PERL_MB_OPT;
PERL_MM_OPT="INSTALL_BASE=/home/markus/perl5"; export PERL_MM_OPT;

nix-shell-dir () {
    if [[ "$NIX_SHELL_DIR" ]] ; then
	echo %{$fg[green]"["$fg_bold[green]"nix:"$reset_color" "$fg[gray]"$NIX_SHELL_DIR"$fg[green]"]"$reset_color%}
    fi
}
